...
import { RichTextKey, Text, Link } from "@suncel/nextjs/components";
...
export const Nav01: SuncelBlock<Nav01Props> = ({ title, subTitle, hasSubtitle, productTitle, feauturesTitle, slug, slug2, link }) => {
  ...
  return (
    <div className={classes?.container}>
          ...
          <Popover.Group className="hidden lg:flex lg:gap-x-12">
            <Popover className="relative">
              <Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900">  
                <Text slug='slug2' value={slug2} tagName='span'/>
            ...
            <Link {...link} className="text-sm font-semibold leading-6 text-gray-900"  >
              <Text slug='slug' value={slug} tagName='span'/>
            </Link>
      ...
      {hasSubtitle && ( <div className='mt-8'>  <CustomRichText slug='subTitle' value={subTitle} /></div>)}
    </div>
  );
};
